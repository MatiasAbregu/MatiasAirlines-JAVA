        ...
        <section>
            ...
            <form action="VueloReservado.jsp" method="post">
                ...
                <table class="tablas">
                    ...
                    <tbody>
                        <c:choose>
                            <c:when test="${origen.equals('NA') && destino.equals('Sydney') || origen.equals('AS') && destino.equals('Auckland')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                            ...
                            <c:when test="${origen.equals('NA') && destino.equals('CDMX') || origen.equals('CiudadMexico') && destino.equals('Auckland')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                ...
                <table class="tablas">
                    ...
                    <tbody>
                        ...
                        <c:when test="${origen.equals('NA') && destino.equals('CiudadMexico') || origen.equals('CDMX') && destino.equals('Auckland')}">
                            <tr>
                                <td>
                                    Hora de salida: 
                                    <% horaS4 = horario.horaSalida() + " : " + horario.minutoSalida();
