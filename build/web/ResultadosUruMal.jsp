        ...
        <section>
            ...
            <form action="VueloReservado.jsp" method="post">
                ...
                <table class="tablas">
                    ...
                    <tbody>
                        <c:choose>
                            <c:when test="${origen.equals('UMP') && destino.equals('Madrid') || origen.equals('EM') && destino.equals('Maldonado')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                            ...
                            <c:when test="${origen.equals('UMP') && destino.equals('SaoPaulo') || origen.equals('BES') && destino.equals('Maldonado')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('UMP') && destino.equals('RioDeJaneiro') || origen.equals('BER') && destino.equals('Maldonado')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('UMP') && destino.equals('NuevaYork') || origen.equals('ENN') && destino.equals('Maldonado')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('UMP') && destino.equals('LA') || origen.equals('ECL') && destino.equals('Maldonado')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('UMP') && destino.equals('Florida') || origen.equals('EFO') && destino.equals('Maldonado')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('UMP') && destino.equals('Toronto') || origen.equals('COT') && destino.equals('Maldonado')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('UMP') && destino.equals('London') || origen.equals('COL') && destino.equals('Maldonado')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('UMP') && destino.equals('Paris') || origen.equals('FP') && destino.equals('Maldonado')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('UMP') && destino.equals('Roma') || origen.equals('IR') && destino.equals('Maldonado')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('UMP') && destino.equals('Lisboa') || origen.equals('PL') && destino.equals('Maldonado')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('UMP') && destino.equals('Oslo') || origen.equals('NO') && destino.equals('Maldonado')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('UMP') && destino.equals('Dublin') || origen.equals('ID') && destino.equals('Maldonado')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('UMP') && destino.equals('Moscu') || origen.equals('RM') && destino.equals('Maldonado')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                                    ...
                                    <td>
                                        Hora de llegada: 
                                        <% horaL1 = horario.horaLlegada(24) + " : " + horario.minutoSalida();
                                            out.print(horaL1);%>
                                        <input type="hidden" name="horaL1" value="<% out.print(horaL1); %>">
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Hora de llegada: 
                                        <% horaL2 = horario.horaLlegada(24) + " : " + horario.minutoSalida();
                                            out.print(horaL2);%>
                                        <input type="hidden" name="horaL2" value="<% out.print(horaL2); %>">
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Hora de llegada: 
                                        <% horaL3 = horario.horaLlegada(24) + " : " + horario.minutoSalida();
                                            out.print(horaL3);%>
                                        <input type="hidden" name="horaL3" value="<% out.print(horaL3); %>">
                                    </td>
                                    <td>
                            ...
                            <c:when test="${origen.equals('UMP') && destino.equals('SanPeter') || origen.equals('RS') && destino.equals('Maldonado')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                                    ...
                                    <td>
                                        Hora de llegada: 
                                        <% horaL1 = horario.horaLlegada(25) + " : " + horario.minutoSalida();
                                            out.print(horaL1);%>
                                        <input type="hidden" name="horaL1" value="<% out.print(horaL1); %>">
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Hora de llegada: 
                                        <% horaL2 = horario.horaLlegada(25) + " : " + horario.minutoSalida();
                                            out.print(horaL2);%>
                                        <input type="hidden" name="horaL2" value="<% out.print(horaL2); %>">
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Hora de llegada: 
                                        <% horaL3 = horario.horaLlegada(25) + " : " + horario.minutoSalida();
                                            out.print(horaL3);%>
                                        <input type="hidden" name="horaL3" value="<% out.print(horaL3); %>">
                                    </td>
                                    <td>
                            ...
                            <c:when test="${origen.equals('UMP') && destino.equals('Auckland') || origen.equals('NA') && destino.equals('Maldonado')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('UMP') && destino.equals('Sydney') || origen.equals('AS') && destino.equals('Maldonado')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('UMP') && destino.equals('CiudadMexico') || origen.equals('CDMX') && destino.equals('Maldonado')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                      ...
                      <c:choose>
                        ...
                        <c:when test="${origen.equals('UMP') && destino.equals('Moscu') || origen.equals('RM') && destino.equals('Maldonado')}">
                            <tr>
                                ...
                                <td>
                                    Hora de llegada: 
                                    <% horaL4 = horario.horaLlegada(24) + " : " + horario.minutoSalida();
                                        out.print(horaL4);%>
                                    <input type="hidden" name="horaL4" value="<% out.print(horaL4); %>">
                                </td>
                                <td>
                            ...
                            <td>
                                Hora de llegada: 
                                <% horaL5 = horario.horaLlegada(24) + " : " + horario.minutoSalida();
                                    out.print(horaL5);%>
                                <input type="hidden" name="horaL5" value="<% out.print(horaL5); %>">
                            </td>
                            <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    Hora de llegada: 
                                    <% horaL6 = horario.horaLlegada(24) + " : " + horario.minutoSalida();
                                        out.print(horaL6);%>
                                    <input type="hidden" name="horaL6" value="<% out.print(horaL6); %>">
                                </td>
                                <td>
                        ...
                        <c:when test="${origen.equals('UMP') && destino.equals('SanPeter') || origen.equals('RS') && destino.equals('Maldonado')}">
                            <tr>
                                ...
                                <td>
                                    Hora de llegada: 
                                    <% horaL4 = horario.horaLlegada(25) + " : " + horario.minutoSalida();
                                        out.print(horaL4);%>
                                    <input type="hidden" name="horaL4" value="<% out.print(horaL4); %>">
                                </td>
                                <td>
                            ...
                            <td>
                                Hora de llegada: 
                                <% horaL5 = horario.horaLlegada(25) + " : " + horario.minutoSalida();
                                    out.print(horaL5);%>
                                <input type="hidden" name="horaL5" value="<% out.print(horaL5); %>">
                            </td>
                            <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    Hora de llegada: 
                                    <% horaL6 = horario.horaLlegada(25) + " : " + horario.minutoSalida();
                                        out.print(horaL6);%>
                                    <input type="hidden" name="horaL6" value="<% out.print(horaL6); %>">
                                </td>
                                <td>
