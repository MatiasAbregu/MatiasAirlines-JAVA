        ...
        <section>
            ...
            <form action="VueloReservado.jsp" method="post">
                ...
                <table class="tablas">
                    ...
                    <tbody>
                        <c:choose>
                            <c:when test="${origen.equals('EFO') && destino.equals('Madrid') || origen.equals('EM') && destino.equals('Florida')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                            ...
                            <c:when test="${origen.equals('EFO') && destino.equals('Toronto') || origen.equals('COT') && destino.equals('Florida')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('EFO') && destino.equals('London') || origen.equals('COL') && destino.equals('Florida')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('EFO') && destino.equals('Paris') || origen.equals('FP') && destino.equals('Florida')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('EFO') && destino.equals('Roma') || origen.equals('IR') && destino.equals('Florida')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('EFO') && destino.equals('Lisboa') || origen.equals('PL') && destino.equals('FLorida')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('EFO') && destino.equals('Oslo') || origen.equals('NO') && destino.equals('Florida')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('EFO') && destino.equals('Dublin') || origen.equals('ID') && destino.equals('Florida')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('EFO') && destino.equals('Moscu') || origen.equals('RM') && destino.equals('Florida')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('EFO') && destino.equals('SanPeter') || origen.equals('RS') && destino.equals('Florida')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('EFO') && destino.equals('Auckland') || origen.equals('NA') && destino.equals('Florida')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('EFO') && destino.equals('Sydney') || origen.equals('AS') && destino.equals('Florida')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('EFO') && destino.equals('CiudadMexico') || origen.equals('CDMX') && destino.equals('Florida')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                     ...
                     <c:choose>
                        ...
                        <c:when test="${origen.equals('EFO') && destino.equals('CiudadMexico') || origen.equals('CDMX') && destino.equals('Florida')}">
                            <tr>
                                ...
                                <td>
                                    <select class="opciones" name="precio4">
                                        <option value="<% out.print(45000 * pasajeros); %>">Turista: <% out.print((45000 * pasajeros) + " ARS"); %></option>
                                        <option value="<% out.print(60000 * pasajeros); %>">Turista Premium: <% out.print((60000 * pasajeros) + " ARS"); %></option>
                                    </select>
                                    <input type="checkbox" class="checkbox" id="c4" onchange="Verificar();" name="check" value=""/>
                                </td>
                            </tr>
