        ...
        <section>
            ...
            <form action="VueloReservado.jsp" method="post">
                ...
                <table class="tablas">
                    ...
                    <tbody>
                        <c:choose>
                            <c:when test="${origen.equals('BER') && destino.equals('Madrid') || origen.equals('EM') && destino.equals('RioDeJanerio')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                            ...
                            <c:when test="${origen.equals('BER') && destino.equals('NuevaYork') || origen.equals('ENN') && destino.equals('RioDeJaneiro')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('BER') && destino.equals('LA') || origen.equals('ECL') && destino.equals('RioDeJanerio')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('BER') && destino.equals('Florida') || origen.equals('EFO') && destino.equals('RioDeJaneiro')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('BER') && destino.equals('Toronto') || origen.equals('COT') && destino.equals('RioDeJaneiro')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('BER') && destino.equals('London') || origen.equals('COL') && destino.equals('RioDeJaneiro')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('BER') && destino.equals('Paris') || origen.equals('FP') && destino.equals('RioDeJaneiro')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('BER') && destino.equals('Roma') || origen.equals('IR') && destino.equals('RioDeJaneiro')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('BER') && destino.equals('Lisboa') || origen.equals('PL') && destino.equals('RioDeJaneiro')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('BER') && destino.equals('Oslo') || origen.equals('NO') && destino.equals('RioDeJaneiro')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('BER') && destino.equals('Dublin') || origen.equals('ID') && destino.equals('RioDeJaneiro')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('BER') && destino.equals('Moscu') || origen.equals('RM') && destino.equals('RioDeJaneiro')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('BER') && destino.equals('SanPeter') || origen.equals('RS') && destino.equals('RioDeJaneiro')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('BER') && destino.equals('Auckland') || origen.equals('NA') && destino.equals('RioDeJaneiro')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('BER') && destino.equals('Sydney') || origen.equals('AS') && destino.equals('RioDeJaneiro')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('BER') && destino.equals('CiudadMexico') || origen.equals('CDMX') && destino.equals('RioDeJaneiro')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
