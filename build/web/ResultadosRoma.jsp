        ...
        <section>
            ...
            <form action="VueloReservado.jsp" method="post">
                ...
                <table class="tablas">
                    ...
                    <tbody>
                      <c:choose>
                        <c:when test="${origen.equals('IR') && destino.equals('Madrid') || origen.equals('EM') && destino.equals('Roma')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                        ...
                        <c:when test="${origen.equals('IR') && destino.equals('Lisboa') || origen.equals('PL') && destino.equals('Roma')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                        ...
                        <c:when test="${origen.equals('IR') && destino.equals('Oslo') || origen.equals('NO') && destino.equals('Roma')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                        ...
                        <c:when test="${origen.equals('IR') && destino.equals('Dublin') || origen.equals('ID') && destino.equals('Roma')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                        ...
                        <c:when test="${origen.equals('IR') && destino.equals('Moscu') || origen.equals('RM') && destino.equals('Roma')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                        ...
                        <c:when test="${origen.equals('IR') && destino.equals('SanPeter') || origen.equals('RS') && destino.equals('Roma')}">
                            <tr>
                                <td>
                                    Hora de salida: 
                                    <% horaS4 = horario.horaSalida() + " : " + horario.minutoSalida();
                        ...
                        <c:when test="${origen.equals('IR') && destino.equals('Auckland') || origen.equals('NA') && destino.equals('Roma')}">
                            <tr>
                                <td>
                                    Hora de salida: 
                                    <% horaS4 = horario.horaSalida() + " : " + horario.minutoSalida();
                        ...
                        <c:when test="${origen.equals('IR') && destino.equals('Sydney') || origen.equals('AS') && destino.equals('Roma')}">
                            <tr>
                                <td>
                                    Hora de salida: 
                                    <% horaS4 = horario.horaSalida() + " : " + horario.minutoSalida();
                        ...
                        <c:when test="${origen.equals('IR') && destino.equals('CiudadMexico') || origen.equals('CDMX') && destino.equals('Roma')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
