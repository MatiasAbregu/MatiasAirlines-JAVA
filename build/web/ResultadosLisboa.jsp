        ...
        <section>
            ...
            <form action="VueloReservado.jsp" method="post">
                ...
                <table class="tablas">
                    ...
                    <tbody>
                        <c:choose>
                            <c:when test="${origen.equals('PL') && destino.equals('Oslo') || origen.equals('NO') && destino.equals('Lisboa')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                            ...
                            <c:when test="${origen.equals('PL') && destino.equals('Dublin') || origen.equals('ID') && destino.equals('Lisboa')}">
                             <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('PL') && destino.equals('Moscu') || origen.equals('RM') && destino.equals('Lisboa')}">
                            <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('PL') && destino.equals('SanPeter') || origen.equals('RS') && destino.equals('Lisboa')}">
                            <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('PL') && destino.equals('Auckland') || origen.equals('NA') && destino.equals('Lisboa')}">
                               <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('PL') && destino.equals('Sydney') || origen.equals('AS') && destino.equals('Lisboa')}">
                              <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                        ...
                        <c:when test="${origen.equals('PL') && destino.equals('CiudadMexico') || origen.equals('CDMX') && destino.equals('Lisboa')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
