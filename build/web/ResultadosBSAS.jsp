        ...
        <section>
            ...
            <form action="VueloReservado.jsp" method="post">
                ...
                <table class="tablas">
                    ...
                    <tbody>
                        <c:choose>
                            <c:when test="${origen.equals('ABE') && destino.equals('Madrid') || origen.equals('EM') && destino.equals('BuenosAires')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                    ...
                                    <td>
                                        <select class="opciones" name="precio1">
                                            <option value="<% out.print(250000 * pasajeros); %>">Turista: <% out.print((250000 * pasajeros) + " ARS"); %></option>
                                            <option value="<% out.print(300000 * pasajeros); %>">Turista Premium: <% out.print((300000 * pasajeros) + " ARS"); %></option>
                                        </select>
                            ...
                            <c:when test="${origen.equals('ABE') && destino.equals('Cordoba') || origen.equals('ACC') && destino.equals('BuenosAires')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                                    ...
                                    <td>
                                        <select class="opciones" name="precio1">
                                            <option value="<% out.print(13000 * pasajeros); %>">Turista: <% out.print((13000 * pasajeros) + " ARS"); %></option>
                                            <option value="<% out.print(18000 * pasajeros); %>">Turista Premium: <% out.print((18000 * pasajeros) + " ARS"); %></option>
                                        </select>
                                        <input type="checkbox" class="checkbox" id="c1" onchange="Verificar();" name="check" value=""/>
                                    </td>
                                </tr>
                            ...
                            <c:when test="${origen.equals('ABE') && destino.equals('Maldonado') || origen.equals('UMP') && destino.equals('BuenosAires')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                                    ...
                                    <td>
                                        Hora de llegada: 
                                        <% horaL1 = horario.horaLlegada(1) + " : " + horario.minutoSalida();
                                            out.print(horaL1);%>
                                        <input type="hidden" name="horaL1" value="<% out.print(horaL1); %>">
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Hora de llegada: 
                                        <% horaL2 = horario.horaLlegada(1) + " : " + horario.minutoSalida();
                                            out.print(horaL2);%>
                                        <input type="hidden" name="horaL2" value="<% out.print(horaL2); %>">
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Hora de llegada: 
                                        <% horaL3 = horario.horaLlegada(1) + " : " + horario.minutoSalida();
                                            out.print(horaL3);%>
                                        <input type="hidden" name="horaL3" value="<% out.print(horaL3); %>">
                                    </td>
                                    <td>
                            ...
                            <c:when test="${origen.equals('ABE') && destino.equals('CerroLargo') || origen.equals('UCM') && destino.equals('BuenosAires')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('ABE') && destino.equals('SaoPaulo') || origen.equals('BES') && destino.equals('BuenosAires')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                                    ...
                                    <td>
                                        <select class="opciones" name="precio1">
                                            <option value="<% out.print(60000 * pasajeros); %>">Turista: <% out.print((60000 * pasajeros) + " ARS"); %></option>
                                            <option value="<% out.print(80000 * pasajeros); %>">Turista Premium: <% out.print((80000 * pasajeros) + " ARS"); %></option>
                                        </select>
                                        <input type="checkbox" class="checkbox" id="c1" onchange="Verificar();" name="check" value=""/>
                                    </td>
                                </tr>
                            ...
                            <c:when test="${origen.equals('ABE') && destino.equals('RioDeJaneiro') || origen.equals('BER') && destino.equals('BuenosAires')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                                    ...
                                    <td>
                                        Hora de llegada: 
                                        <% horaL1 = horario.horaLlegada(4) + " : " + horario.minutoSalida();
                                            out.print(horaL1);%>
                                        <input type="hidden" name="horaL1" value="<% out.print(horaL1); %>">
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Hora de llegada: 
                                        <% horaL2 = horario.horaLlegada(4) + " : " + horario.minutoSalida();
                                            out.print(horaL2);%>
                                        <input type="hidden" name="horaL2" value="<% out.print(horaL2); %>">
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Hora de llegada: 
                                        <% horaL3 = horario.horaLlegada(4) + " : " + horario.minutoSalida();
                                            out.print(horaL3);%>
                                        <input type="hidden" name="horaL3" value="<% out.print(horaL3); %>">
                                    </td>
                                    <td>
                            ...
                            <c:when test="${origen.equals('ABE') && destino.equals('NuevaYork') || origen.equals('ENN') && destino.equals('BuenosAires')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('ABE') && destino.equals('LA') || origen.equals('ECL') && destino.equals('BuenosAires')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('ABE') && destino.equals('Florida') || origen.equals('EFO') && destino.equals('BuenosAires')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('ABE') && destino.equals('Toronto') || origen.equals('COT') && destino.equals('BuenosAires')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('ABE') && destino.equals('London') || origen.equals('COL') && destino.equals('BuenosAires')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('ABE') && destino.equals('Paris') || origen.equals('FP') && destino.equals('BuenosAires')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('ABE') && destino.equals('Roma') || origen.equals('IR') && destino.equals('BuenosAires')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                                    ...
                                    <td>
                                        Hora de llegada: 
                                        <% horaL1 = horario.horaLlegada(19) + " : " + horario.minutoSalida();
                                            out.print(horaL1);%>
                                        <input type="hidden" name="horaL1" value="<% out.print(horaL1); %>">
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Hora de llegada: 
                                        <% horaL2 = horario.horaLlegada(19) + " : " + horario.minutoSalida();
                                            out.print(horaL2);%>
                                        <input type="hidden" name="horaL2" value="<% out.print(horaL2); %>">
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Hora de llegada: 
                                        <% horaL3 = horario.horaLlegada(19) + " : " + horario.minutoSalida();
                                            out.print(horaL3);%>
                                        <input type="hidden" name="horaL3" value="<% out.print(horaL3); %>">
                                    </td>
                                    <td>
                            ...
                            <c:when test="${origen.equals('ABE') && destino.equals('Lisboa') || origen.equals('PL') && destino.equals('BuenosAires')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('ABE') && destino.equals('Oslo') || origen.equals('NO') && destino.equals('BuenosAires')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                                    ...
                                    <td>
                                        <select class="opciones" name="precio1">
                                            ...
                                            <option value="<% out.print(360000 * pasajeros); %>">Turista Premium: <% out.print((360000 * pasajeros) + " ARS"); %></option>
                                        </select>
                                        <input type="checkbox" class="checkbox" id="c1" onchange="Verificar();" name="check" value=""/>
                                    </td>
                                </tr>
                            ...
                            <c:when test="${origen.equals('ABE') && destino.equals('Dublin') || origen.equals('ID') && destino.equals('BuenosAires')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('ABE') && destino.equals('Moscu') || origen.equals('RM') && destino.equals('BuenosAires')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                                    ...
                                    <td>
                                        Hora de llegada: 
                                        <% horaL1 = horario.horaLlegada(28) + " : " + horario.minutoSalida();
                                            out.print(horaL1);%>
                                        <input type="hidden" name="horaL1" value="<% out.print(horaL1); %>">
                                    </td>
                                    <td>
                                        <select class="opciones" name="precio1">
                                            <option value="<% out.print(320000 * pasajeros); %>">Turista: <% out.print((320000 * pasajeros) + " ARS"); %></option>
                                            <option value="<% out.print(380000 * pasajeros); %>">Turista Premium: <% out.print((380000 * pasajeros) + " ARS"); %></option>
                                        </select>
                                        <input type="checkbox" class="checkbox" id="c1" onchange="Verificar();" name="check" value=""/>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        Hora de llegada: 
                                        <% horaL2 = horario.horaLlegada(28) + " : " + horario.minutoSalida();
                                            out.print(horaL2);%>
                                        <input type="hidden" name="horaL2" value="<% out.print(horaL2); %>">
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Hora de llegada: 
                                        <% horaL3 = horario.horaLlegada(28) + " : " + horario.minutoSalida();
                                            out.print(horaL3);%>
                                        <input type="hidden" name="horaL3" value="<% out.print(horaL3); %>">
                                    </td>
                                    <td>
                            ...
                            <c:when test="${origen.equals('ABE') && destino.equals('SanPeter') || origen.equals('RS') && destino.equals('BuenosAires')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                                    ...
                                    <td>
                                        Hora de llegada: 
                                        <% horaL1 = horario.horaLlegada(29) + " : " + horario.minutoSalida();
                                            out.print(horaL1);%>
                                        <input type="hidden" name="horaL1" value="<% out.print(horaL1); %>">
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Hora de llegada: 
                                        <% horaL2 = horario.horaLlegada(29) + " : " + horario.minutoSalida();
                                            out.print(horaL2);%>
                                        <input type="hidden" name="horaL2" value="<% out.print(horaL2); %>">
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Hora de llegada: 
                                        <% horaL3 = horario.horaLlegada(29) + " : " + horario.minutoSalida();
                                            out.print(horaL3);%>
                                        <input type="hidden" name="horaL3" value="<% out.print(horaL3); %>">
                                    </td>
                                    <td>
                            ...
                            <c:when test="${origen.equals('ABE') && destino.equals('Auckland') || origen.equals('NA') && destino.equals('BuenosAires')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('ABE') && destino.equals('Sydney') || origen.equals('AS') && destino.equals('BuenosAires')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                                    ...
                                    <td>
                                        Hora de llegada: 
                                        <% horaL1 = horario.horaLlegada(22) + " : " + horario.minutoSalida();
                                            out.print(horaL1);%>
                                        <input type="hidden" name="horaL1" value="<% out.print(horaL1); %>">
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Hora de llegada: 
                                        <% horaL2 = horario.horaLlegada(22) + " : " + horario.minutoSalida();
                                            out.print(horaL2);%>
                                        <input type="hidden" name="horaL2" value="<% out.print(horaL2); %>">
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Hora de llegada: 
                                        <% horaL3 = horario.horaLlegada(22) + " : " + horario.minutoSalida();
                                            out.print(horaL3);%>
                                        <input type="hidden" name="horaL3" value="<% out.print(horaL3); %>">
                                    </td>
                                    <td>
                            ...
                            <c:when test="${origen.equals('ABE') && destino.equals('CiudadMexico') || origen.equals('CDMX') && destino.equals('BuenosAires')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                                    ...
                                    <td>
                                        Hora de llegada: 
                                        <% horaL1 = horario.horaLlegada(10) + " : " + horario.minutoSalida();
                                            out.print(horaL1);%>
                                        <input type="hidden" name="horaL1" value="<% out.print(horaL1); %>">
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Hora de llegada: 
                                        <% horaL2 = horario.horaLlegada(10) + " : " + horario.minutoSalida();
                                            out.print(horaL2);%>
                                        <input type="hidden" name="horaL2" value="<% out.print(horaL2); %>">
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Hora de llegada: 
                                        <% horaL3 = horario.horaLlegada(10) + " : " + horario.minutoSalida();
                                            out.print(horaL3);%>
                                        <input type="hidden" name="horaL3" value="<% out.print(horaL3); %>">
                                    </td>
                                    <td>
                    ...
                    <c:choose>
                        ...
                        <c:when test="${origen.equals('ABE') && destino.equals('Maldonado') || origen.equals('UMP') && destino.equals('BuenosAires')}">
                            <tr>
                                ...
                                <td>
                                    Hora de llegada: 
                                    <% horaL4 = horario.horaLlegada(1) + " : " + horario.minutoSalida();
                                        out.print(horaL4);%>
                                    <input type="hidden" name="horaL4" value="<% out.print(horaL4); %>">
                                </td>
                                <td>
                            ...
                            <td>
                                Hora de llegada: 
                                <% horaL5 = horario.horaLlegada(1) + " : " + horario.minutoSalida();
                                    out.print(horaL5);%>
                                <input type="hidden" name="horaL5" value="<% out.print(horaL5); %>">
                            </td>
                            <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    Hora de llegada: 
                                    <% horaL6 = horario.horaLlegada(1) + " : " + horario.minutoSalida();
                                        out.print(horaL6);%>
                                    <input type="hidden" name="horaL6" value="<% out.print(horaL6); %>">
                                </td>
                                <td>
                        ...
                        <c:when test="${origen.equals('ABE') && destino.equals('RioDeJaneiro') || origen.equals('BER') && destino.equals('BuenosAires')}">
                            <tr>
                                ...
                                <td>
                                    Hora de llegada: 
                                    <% horaL4 = horario.horaLlegada(4) + " : " + horario.minutoSalida();
                                        out.print(horaL4);%>
                                    <input type="hidden" name="horaL4" value="<% out.print(horaL4); %>">
                                </td>
                                <td>
                            ...
                            <td>
                                Hora de llegada: 
                                <% horaL5 = horario.horaLlegada(4) + " : " + horario.minutoSalida();
                                    out.print(horaL5);%>
                                <input type="hidden" name="horaL5" value="<% out.print(horaL5); %>">
                            </td>
                            <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    Hora de llegada: 
                                    <% horaL6 = horario.horaLlegada(4) + " : " + horario.minutoSalida();
                                        out.print(horaL6);%>
                                    <input type="hidden" name="horaL6" value="<% out.print(horaL6); %>">
                                </td>
                                <td>
                        ...
                        <c:when test="${origen.equals('ABE') && destino.equals('Florida') || origen.equals('EFO') && destino.equals('BuenosAires')}">
                            <tr>
                                ...
                                <td>
                                    Hora de llegada: 
                                    <% horaL4 = horario.horaLlegada(14) + " : " + horario.minutoSalida();
                                        out.print(horaL4);%>
                                    <input type="hidden" name="horaL4" value="<% out.print(horaL4); %>">
                                </td>
                                <td>
                            ...
                            <td>
                                Hora de llegada: 
                                <% horaL5 = horario.horaLlegada(14) + " : " + horario.minutoSalida();
                                    out.print(horaL5);%>
                                <input type="hidden" name="horaL5" value="<% out.print(horaL5); %>">
                            </td>
                            <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    Hora de llegada: 
                                    <% horaL6 = horario.horaLlegada(14) + " : " + horario.minutoSalida();
                                        out.print(horaL6);%>
                                    <input type="hidden" name="horaL6" value="<% out.print(horaL6); %>">
                                </td>
                                <td>
                        ...
                        <c:when test="${origen.equals('ABE') && destino.equals('Roma') || origen.equals('IR') && destino.equals('BuenosAires')}">
                            <tr>
                                ...
                                <td>
                                    Hora de llegada: 
                                    <% horaL4 = horario.horaLlegada(19) + " : " + horario.minutoSalida();
                                        out.print(horaL4);%>
                                    <input type="hidden" name="horaL4" value="<% out.print(horaL4); %>">
                                </td>
                                <td>
                            ...
                            <td>
                                Hora de llegada: 
                                <% horaL5 = horario.horaLlegada(19) + " : " + horario.minutoSalida();
                                    out.print(horaL5);%>
                                <input type="hidden" name="horaL5" value="<% out.print(horaL5); %>">
                            </td>
                            <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    Hora de llegada: 
                                    <% horaL6 = horario.horaLlegada(19) + " : " + horario.minutoSalida();
                                        out.print(horaL6);%>
                                    <input type="hidden" name="horaL6" value="<% out.print(horaL6); %>">
                                </td>
                                <td>
                        ...
                        <c:when test="${origen.equals('ABE') && destino.equals('Moscu') || origen.equals('RM') && destino.equals('BuenosAires')}">
                            <tr>
                                ...
                                <td>
                                    Hora de llegada: 
                                    <% horaL4 = horario.horaLlegada(28) + " : " + horario.minutoSalida();
                                        out.print(horaL4);%>
                                    <input type="hidden" name="horaL4" value="<% out.print(horaL4); %>">
                                </td>
                                <td>
                            ...
                            <td>
                                Hora de llegada: 
                                <% horaL5 = horario.horaLlegada(28) + " : " + horario.minutoSalida();
                                    out.print(horaL5);%>
                                <input type="hidden" name="horaL5" value="<% out.print(horaL5); %>">
                            </td>
                            <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    Hora de llegada: 
                                    <% horaL6 = horario.horaLlegada(28) + " : " + horario.minutoSalida();
                                        out.print(horaL6);%>
                                    <input type="hidden" name="horaL6" value="<% out.print(horaL6); %>">
                                </td>
                                <td>
                        ...
                        <c:when test="${origen.equals('ABE') && destino.equals('SanPeter') || origen.equals('RS') && destino.equals('BuenosAires')}">
                            <tr>
                                ...
                                <td>
                                    Hora de llegada: 
                                    <% horaL4 = horario.horaLlegada(29) + " : " + horario.minutoSalida();
                                        out.print(horaL4);%>
                                    <input type="hidden" name="horaL4" value="<% out.print(horaL4); %>">
                                </td>
                                <td>
                            ...
                            <td>
                                Hora de llegada: 
                                <% horaL5 = horario.horaLlegada(29) + " : " + horario.minutoSalida();
                                    out.print(horaL5);%>
                                <input type="hidden" name="horaL5" value="<% out.print(horaL5); %>">
                            </td>
                            <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    Hora de llegada: 
                                    <% horaL6 = horario.horaLlegada(29) + " : " + horario.minutoSalida();
                                        out.print(horaL6);%>
                                    <input type="hidden" name="horaL6" value="<% out.print(horaL6); %>">
                                </td>
                                <td>
                        ...
                        <c:when test="${origen.equals('ABE') && destino.equals('Sydney') || origen.equals('AS') && destino.equals('BuenosAires')}">
                            <tr>
                                ...
                                <td>
                                    Hora de llegada: 
                                    <% horaL4 = horario.horaLlegada(22) + " : " + horario.minutoSalida();
                                        out.print(horaL4);%>
                                    <input type="hidden" name="horaL4" value="<% out.print(horaL4); %>">
                                </td>
                                <td>
                            ...
                            <td>
                                Hora de llegada: 
                                <% horaL5 = horario.horaLlegada(22) + " : " + horario.minutoSalida();
                                    out.print(horaL5);%>
                                <input type="hidden" name="horaL5" value="<% out.print(horaL5); %>">
                            </td>
                            <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    Hora de llegada: 
                                    <% horaL6 = horario.horaLlegada(22) + " : " + horario.minutoSalida();
                                        out.print(horaL6);%>
                                    <input type="hidden" name="horaL6" value="<% out.print(horaL6); %>">
                                </td>
                                <td>
                        ...
                        <c:when test="${origen.equals('ABE') && destino.equals('CiudadMexico') || origen.equals('CDMX') && destino.equals('BuenosAires')}">
                            <tr>
                                ...
                                <td>
                                    Hora de llegada: 
                                    <% horaL4 = horario.horaLlegada(10) + " : " + horario.minutoSalida();
                                            out.print(horaL4);%>
                                    <input type="hidden" name="horaL4" value="<% out.print(horaL4); %>">
                                </td>
                                <td>
                            ...
                            <td>
                                Hora de llegada: 
                                <% horaL5 = horario.horaLlegada(10) + " : " + horario.minutoSalida();
                                    out.print(horaL5);%>
                                <input type="hidden" name="horaL5" value="<% out.print(horaL5); %>">
                            </td>
                            <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    Hora de llegada: 
                                    <% horaL6 = horario.horaLlegada(10) + " : " + horario.minutoSalida();
                                        out.print(horaL6);%>
                                    <input type="hidden" name="horaL6" value="<% out.print(horaL6); %>">
                                </td>
                                <td>
