        ...
        <section>
            ...
            <form action="VueloReservado.jsp" method="post">
                ...
                <table class="tablas">
                    ...
                    <tbody>
                        <c:choose>
                            <c:when test="${origen.equals('FP') && destino.equals('Madrid') || origen.equals('EM') && destino.equals('Paris')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                            ...
                            <c:when test="${origen.equals('FP') && destino.equals('Roma') || origen.equals('IR') && destino.equals('Paris')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('FP') && destino.equals('Lisboa') || origen.equals('PL') && destino.equals('Paris')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('FP') && destino.equals('Oslo') || origen.equals('NO') && destino.equals('Paris')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('FP') && destino.equals('Dublin') || origen.equals('ID') && destino.equals('Paris')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('FP') && destino.equals('Moscu') || origen.equals('RM') && destino.equals('Paris')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('FP') && destino.equals('SanPeter') || origen.equals('RS') && destino.equals('Paris')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('FP') && destino.equals('Auckland') || origen.equals('NA') && destino.equals('Paris')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('FP') && destino.equals('Sydney') || origen.equals('AS') && destino.equals('Paris')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('FP') && destino.equals('CiudadMexico') || origen.equals('CDMX') && destino.equals('Paris')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
