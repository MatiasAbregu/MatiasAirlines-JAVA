        ...
        <section>
            ...
            <form action="VueloReservado.jsp" method="post">
                ...
                <table class="tablas">
                    ...
                    <tbody>
                        <c:choose>
                            <c:when test="${origen.equals('EM') && destino.equals('Lisboa') || origen.equals('PL') && destino.equals('Madrid')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                            ...
                            <c:when test="${origen.equals('EM') && destino.equals('Oslo') || origen.equals('NO') && destino.equals('Madrid')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('EM') && destino.equals('Dublin') || origen.equals('ID') && destino.equals('Madrid')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('EM') && destino.equals('Moscu') || origen.equals('RM') && destino.equals('Madrid')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('EM') && destino.equals('SanPeter') || origen.equals('RS') && destino.equals('Madrid')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('EM') && destino.equals('Auckland') || origen.equals('NA') && destino.equals('Madrid')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                                    ...
                                    <td>
                                        Hora de llegada: 
                                        <% horaL1 = horario.horaLlegada(27) + " : " + horario.minutoSalida();
                                            out.print(horaL1);%>
                                        <input type="hidden" name="horaL1" value="<% out.print(horaL1); %>">
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Hora de llegada: 
                                        <% horaL2 = horario.horaLlegada(27) + " : " + horario.minutoSalida();
                                            out.print(horaL2);%>
                                        <input type="hidden" name="horaL2" value="<% out.print(horaL2); %>">
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Hora de llegada: 
                                        <% horaL3 = horario.horaLlegada(27) + " : " + horario.minutoSalida();
                                            out.print(horaL3);%>
                                        <input type="hidden" name="horaL3" value="<% out.print(horaL3); %>">
                                    </td>
                                    <td>
                            ...
                            <c:when test="${origen.equals('EM') && destino.equals('Sydney') || origen.equals('AS') && destino.equals('Madrid')}">
                               <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('EM') && destino.equals('CiudadMexico') || origen.equals('CDMX') && destino.equals('Madrid')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                        ...
                        <c:choose>
                            ...
                            <c:when test="${origen.equals('EM') && destino.equals('Auckland') || origen.equals('NA') && destino.equals('Madrid')}">
                              <tr>
                                ...
                                <td>
                                    Hora de llegada: 
                                    <% horaL4 = horario.horaLlegada(27) + " : " + horario.minutoSalida();
                                            out.print(horaL4);%>
                                    <input type="hidden" name="horaL4" value="<% out.print(horaL4); %>">
                                </td>
                                <td>
                            ...
                            <td>
                                Hora de llegada: 
                                <% horaL5 = horario.horaLlegada(27) + " : " + horario.minutoSalida();
                                    out.print(horaL5);%>
                                <input type="hidden" name="horaL5" value="<% out.print(horaL5); %>">
                            </td>
                            <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    Hora de llegada: 
                                    <% horaL6 = horario.horaLlegada(27) + " : " + horario.minutoSalida();
                                        out.print(horaL6);%>
                                    <input type="hidden" name="horaL6" value="<% out.print(horaL6); %>">
                                </td>
                                <td>
