        ...
        <section>
            ...
            <form action="VueloReservado.jsp" method="post">
                ...
                <table class="tablas">
                    ...
                    <tbody>
                        <c:choose>
                            <c:when test="${origen.equals('ECL') && destino.equals('Madrid') || origen.equals('EM') && destino.equals('LA')}">
                                 <tr>
                                    <td>
                                        Hora de salida: 
                            ...
                            <c:when test="${origen.equals('ECL') && destino.equals('Florida') || origen.equals('EFO') && destino.equals('LA')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('ECL') && destino.equals('Toronto') || origen.equals('COT') && destino.equals('LA')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('ECL') && destino.equals('London') || origen.equals('COL') && destino.equals('LA')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('ECL') && destino.equals('Paris') || origen.equals('FP') && destino.equals('LA')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('ECL') && destino.equals('Roma') || origen.equals('IR') && destino.equals('LA')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('ECL') && destino.equals('Lisboa') || origen.equals('PL') && destino.equals('LA')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('ECL') && destino.equals('Oslo') || origen.equals('NO') && destino.equals('LA')}">
                               <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('ECL') && destino.equals('Dublin') || origen.equals('ID') && destino.equals('LA')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('ECL') && destino.equals('Moscu') || origen.equals('RM') && destino.equals('LA')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('ECL') && destino.equals('SanPeter') || origen.equals('RS') && destino.equals('LA')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('ECL') && destino.equals('Auckland') || origen.equals('NA') && destino.equals('LA')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('ECL') && destino.equals('Sydney') || origen.equals('AS') && destino.equals('LA')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('ECL') && destino.equals('CiudadMexico') || origen.equals('CDMX') && destino.equals('LA')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
