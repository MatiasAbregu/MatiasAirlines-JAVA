        ...
        <section>
            ...
            <form action="VueloReservado.jsp" method="post">
                ...
                <table class="tablas">
                    ...
                    <tbody>
                        <c:choose>
                            <c:when test="${origen.equals('RS') && destino.equals('Auckland') || origen.equals('NA') && destino.equals('SanPeter')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                            ...
                            <c:when test="${origen.equals('RS') && destino.equals('Sydney') || origen.equals('AS') && destino.equals('SanPeter')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('RS') && destino.equals('CDMX') || origen.equals('CiudadMexico') && destino.equals('SanPeter')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
