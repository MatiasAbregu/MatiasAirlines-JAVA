        ...
        <section>
            ...
            <form action="VueloReservado.jsp" method="post">
                ...
                <table class="tablas">
                    ...
                    <tbody>
                        <c:choose>
                            <c:when test="${origen.equals('ENN') && destino.equals('Madrid') || origen.equals('EM') && destino.equals('NuevaYork')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                    ...
                                    <td>
                                        Hora de llegada: 
                                        <% horaL1 = horario.horaLlegada(7) + " : " + horario.minutoSalida();
                                            out.print(horaL1);%>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Hora de llegada: 
                                        <% horaL2 = horario.horaLlegada(7) + " : " + horario.minutoSalida();
                                            out.print(horaL2);%>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Hora de llegada: 
                                        <% horaL3 = horario.horaLlegada(7) + " : " + horario.minutoSalida();
                                            out.print(horaL3);%>
                            ...
                            <c:when test="${origen.equals('ENN') && destino.equals('LA') || origen.equals('ECL') && destino.equals('NuevaYork')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                                    ...
                                    <td>
                                        Hora de llegada: 
                                        <% horaL1 = horario.horaLlegada(6) + " : " + horario.minutoSalida();
                                            out.print(horaL1);%>
                                        <input type="hidden" name="horaL1" value="<% out.print(horaL1); %>">
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Hora de llegada: 
                                        <% horaL2 = horario.horaLlegada(6) + " : " + horario.minutoSalida();
                                            out.print(horaL2);%>
                                        <input type="hidden" name="horaL2" value="<% out.print(horaL2); %>">
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Hora de llegada: 
                                        <% horaL3 = horario.horaLlegada(6) + " : " + horario.minutoSalida();
                                            out.print(horaL3);%>
                                        <input type="hidden" name="horaL3" value="<% out.print(horaL3); %>">
                                    </td>
                                    <td>
                            ...
                            <c:when test="${origen.equals('ENN') && destino.equals('Florida') || origen.equals('EFO') && destino.equals('NuevaYork')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('ENN') && destino.equals('Toronto') || origen.equals('COT') && destino.equals('NuevaYork')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('ENN') && destino.equals('London') || origen.equals('COL') && destino.equals('NuevaYork')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('ENN') && destino.equals('Paris') || origen.equals('FP') && destino.equals('NuevaYork')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                                    ...
                                    <td>
                                        Hora de llegada: 
                                        <% horaL1 = horario.horaLlegada(8) + " : " + horario.minutoSalida();
                                            out.print(horaL1);%>
                                        <input type="hidden" name="horaL1" value="<% out.print(horaL1); %>">
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Hora de llegada: 
                                        <% horaL2 = horario.horaLlegada(8) + " : " + horario.minutoSalida();
                                            out.print(horaL2);%>
                                        <input type="hidden" name="horaL2" value="<% out.print(horaL2); %>">
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Hora de llegada: 
                                        <% horaL3 = horario.horaLlegada(8) + " : " + horario.minutoSalida();
                                            out.print(horaL3);%>
                                        <input type="hidden" name="horaL3" value="<% out.print(horaL3); %>">
                                    </td>
                                    <td>
                            ...
                            <c:when test="${origen.equals('ENN') && destino.equals('Roma') || origen.equals('IR') && destino.equals('NuevaYork')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('ENN') && destino.equals('Lisboa') || origen.equals('PL') && destino.equals('NuevaYork')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('ENN') && destino.equals('Oslo') || origen.equals('NO') && destino.equals('NuevaYork')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('ENN') && destino.equals('Dublin') || origen.equals('ID') && destino.equals('NuevaYork')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('ENN') && destino.equals('Moscu') || origen.equals('RM') && destino.equals('NuevaYork')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('ENN') && destino.equals('SanPeter') || origen.equals('RS') && destino.equals('NuevaYork')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('ENN') && destino.equals('Auckland') || origen.equals('NA') && destino.equals('NuevaYork')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('ENN') && destino.equals('Sydney') || origen.equals('AS') && destino.equals('NuevaYork')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('ENN') && destino.equals('CiudadMexico') || origen.equals('CDMX') && destino.equals('NuevaYork')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                    ...
                    <tbody>
                        <c:choose>
                            <c:when test="${origen.equals('ENN') && destino.equals('Madrid') || origen.equals('EM') && destino.equals('NuevaYork')}">
                                <tr>
                                    ...
                                    <td>
                                        Hora de llegada: 
                                        <% horaL4 = horario.horaLlegada(7) + " : " + horario.minutoSalida();
                                            out.print(horaL4);%>
                            ...
                            <td>
                                Hora de llegada: 
                                <% horaL5 = horario.horaLlegada(7) + " : " + horario.minutoSalida();
                                    out.print(horaL5);%>
                            ...
                            <tr>
                                ...
                                <td>
                                    Hora de llegada: 
                                    <% horaL6 = horario.horaLlegada(7) + " : " + horario.minutoSalida();
                                        out.print(horaL6);%>
                        ...
                        <c:when test="${origen.equals('ENN') && destino.equals('LA') || origen.equals('ECL') && destino.equals('NuevaYork')}">
                            <tr>
                                ...
                                <td>
                                    Hora de llegada: 
                                    <% horaL4 = horario.horaLlegada(6) + " : " + horario.minutoSalida();
                                        out.print(horaL4);%>
                                    <input type="hidden" name="horaL4" value="<% out.print(horaL4); %>">
                                </td>
                                <td>
                            ...
                            <td>
                                Hora de llegada: 
                                <% horaL5 = horario.horaLlegada(6) + " : " + horario.minutoSalida();
                                    out.print(horaL5);%>
                                <input type="hidden" name="horaL5" value="<% out.print(horaL5); %>">
                            </td>
                            <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    Hora de llegada: 
                                    <% horaL6 = horario.horaLlegada(6) + " : " + horario.minutoSalida();
                                        out.print(horaL6);%>
                                    <input type="hidden" name="horaL6" value="<% out.print(horaL6); %>">
                                </td>
                                <td>
                        ...
                        <c:when test="${origen.equals('ENN') && destino.equals('Paris') || origen.equals('FP') && destino.equals('NuevaYork')}">
                            <tr>
                                ...
                                <td>
                                    Hora de llegada: 
                                    <% horaL4 = horario.horaLlegada(8) + " : " + horario.minutoSalida();
                                            out.print(horaL4);%>
                                    <input type="hidden" name="horaL4" value="<% out.print(horaL4); %>">
                                </td>
                                <td>
                            ...
                            <td>
                                Hora de llegada: 
                                <% horaL5 = horario.horaLlegada(8) + " : " + horario.minutoSalida();
                                    out.print(horaL5);%>
                                <input type="hidden" name="horaL5" value="<% out.print(horaL5); %>">
                            </td>
                            <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    Hora de llegada: 
                                    <% horaL6 = horario.horaLlegada(8) + " : " + horario.minutoSalida();
                                        out.print(horaL6);%>
                                    <input type="hidden" name="horaL6" value="<% out.print(horaL6); %>">
                                </td>
                                <td>
