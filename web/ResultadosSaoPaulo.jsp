        ...
        <section>
            ...
            <form action="VueloReservado.jsp" method="post">
                ...
                <table class="tablas">
                    ...
                    <tbody>
                        <c:choose>
                            <c:when test="${origen.equals('BES') && destino.equals('Madrid') || origen.equals('EM') && destino.equals('SaoPaulo')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                            ...
                            <c:when test="${origen.equals('BES') && destino.equals('RioDeJaneiro') || origen.equals('BER') && destino.equals('SaoPaulo')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('BES') && destino.equals('NuevaYork') || origen.equals('ENN') && destino.equals('SaoPaulo')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('BES') && destino.equals('LA') || origen.equals('ECL') && destino.equals('SaoPaulo')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('BES') && destino.equals('Florida') || origen.equals('EFO') && destino.equals('SaoPaulo')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                                    ...
                                    <td>
                                        Hora de llegada: 
                                        <% horaL1 = horario.horaLlegada(9) + " : " + horario.minutoSalida();
                                            out.print(horaL1);%>
                                        <input type="hidden" name="horaL1" value="<% out.print(horaL1); %>">
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Hora de llegada: 
                                        <% horaL2 = horario.horaLlegada(9) + " : " + horario.minutoSalida();
                                            out.print(horaL2);%>
                                        <input type="hidden" name="horaL2" value="<% out.print(horaL2); %>">
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Hora de llegada: 
                                        <% horaL3 = horario.horaLlegada(9) + " : " + horario.minutoSalida();
                                            out.print(horaL3);%>
                                        <input type="hidden" name="horaL3" value="<% out.print(horaL3); %>">
                                    </td>
                                    <td>
                            ...
                            <c:when test="${origen.equals('BES') && destino.equals('Toronto') || origen.equals('COT') && destino.equals('SaoPaulo')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('BES') && destino.equals('London') || origen.equals('COL') && destino.equals('SaoPaulo')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('BES') && destino.equals('Paris') || origen.equals('FP') && destino.equals('SaoPaulo')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                                    ...
                                    <td>
                                        Hora de llegada: 
                                        <% horaL1 = horario.horaLlegada(11) + " : " + horario.minutoSalida();
                                            out.print(horaL1);%>
                                        <input type="hidden" name="horaL1" value="<% out.print(horaL1); %>">
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Hora de llegada: 
                                        <% horaL2 = horario.horaLlegada(11) + " : " + horario.minutoSalida();
                                            out.print(horaL2);%>
                                        <input type="hidden" name="horaL2" value="<% out.print(horaL2); %>">
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Hora de llegada: 
                                        <% horaL3 = horario.horaLlegada(11) + " : " + horario.minutoSalida();
                                            out.print(horaL3);%>
                                        <input type="hidden" name="horaL3" value="<% out.print(horaL3); %>">
                                    </td>
                                    <td>
                            ...
                            <c:when test="${origen.equals('BES') && destino.equals('Roma') || origen.equals('IR') && destino.equals('SaoPaulo')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('BES') && destino.equals('Lisboa') || origen.equals('PL') && destino.equals('SaoPaulo')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('BES') && destino.equals('Oslo') || origen.equals('NO') && destino.equals('SaoPaulo')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('BES') && destino.equals('Dublin') || origen.equals('ID') && destino.equals('SaoPaulo')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('BES') && destino.equals('Moscu') || origen.equals('RM') && destino.equals('SaoPaulo')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                                    ...
                                    <td>
                                        <select class="opciones" name="precio1">
                                            ...
                                            <option value="<% out.print(350000 * pasajeros); %>">Turista Premium: <% out.print((350000 * pasajeros) + " ARS"); %></option>
                                        </select>
                                        <input type="checkbox" class="checkbox" id="c1" onchange="Verificar();" name="check" value=""/>
                                    </td>
                                </tr>
                            ...
                            <c:when test="${origen.equals('BES') && destino.equals('SanPeter') || origen.equals('RS') && destino.equals('SaoPaulo')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('BES') && destino.equals('Auckland') || origen.equals('NA') && destino.equals('SaoPaulo')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                                    ...
                                    <td>
                                        Hora de llegada: 
                                        <% horaL1 = horario.horaLlegada(21) + " : " + horario.minutoSalida();
                                            out.print(horaL1);%>
                                        <input type="hidden" name="horaL1" value="<% out.print(horaL1); %>">
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Hora de llegada: 
                                        <% horaL2 = horario.horaLlegada(21) + " : " + horario.minutoSalida();
                                            out.print(horaL2);%>
                                        <input type="hidden" name="horaL2" value="<% out.print(horaL2); %>">
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Hora de llegada: 
                                        <% horaL3 = horario.horaLlegada(21) + " : " + horario.minutoSalida();
                                            out.print(horaL3);%>
                                        <input type="hidden" name="horaL3" value="<% out.print(horaL3); %>">
                                    </td>
                                    <td>
                            ...
                            <c:when test="${origen.equals('BES') && destino.equals('Sydney') || origen.equals('AS') && destino.equals('SaoPaulo')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('BES') && destino.equals('CiudadMexico') || origen.equals('CDMX') && destino.equals('SaoPaulo')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                                    ...
                                    <td>
                                        <select class="opciones" name="precio1">
                                            ...
                                            <option value="<% out.print(100000 * pasajeros); %>">Turista Premium: <% out.print((100000 * pasajeros) + " ARS"); %></option>
                                        </select>
                                        <input type="checkbox" class="checkbox" id="c1" onchange="Verificar();" name="check" value=""/>
                                    </td>
                                </tr>
                        ...
                        <c:choose>
                            ...
                            <c:when test="${origen.equals('BES') && destino.equals('Florida') || origen.equals('EFO') && destino.equals('SaoPaulo')}">
                                <tr>
                                    ...
                                    <td>
                                        Hora de llegada: 
                                        <% horaL4 = horario.horaLlegada(9) + " : " + horario.minutoSalida();
                                            out.print(horaL4);%>
                                        <input type="hidden" name="horaL4" value="<% out.print(horaL4); %>">
                                    </td>
                                    <td>
                            ...
                            <td>
                                Hora de llegada: 
                                <% horaL5 = horario.horaLlegada(9) + " : " + horario.minutoSalida();
                                    out.print(horaL5);%>
                                <input type="hidden" name="horaL5" value="<% out.print(horaL5); %>">
                            </td>
                            <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    Hora de llegada: 
                                    <% horaL6 = horario.horaLlegada(9) + " : " + horario.minutoSalida();
                                        out.print(horaL6);%>
                                    <input type="hidden" name="horaL6" value="<% out.print(horaL6); %>">
                                </td>
                                <td>
                            ...
                            <c:when test="${origen.equals('BES') && destino.equals('Paris') || origen.equals('FP') && destino.equals('SaoPaulo')}">
                                <tr>
                                    ...
                                    <td>
                                        Hora de llegada: 
                                        <% horaL4 = horario.horaLlegada(11) + " : " + horario.minutoSalida();
                                            out.print(horaL4);%>
                                        <input type="hidden" name="horaL4" value="<% out.print(horaL4); %>">
                                    </td>
                                    <td>
                            ...
                            <td>
                                Hora de llegada: 
                                <% horaL5 = horario.horaLlegada(11) + " : " + horario.minutoSalida();
                                    out.print(horaL5);%>
                                <input type="hidden" name="horaL5" value="<% out.print(horaL5); %>">
                            </td>
                            <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    Hora de llegada: 
                                    <% horaL6 = horario.horaLlegada(11) + " : " + horario.minutoSalida();
                                        out.print(horaL6);%>
                                    <input type="hidden" name="horaL6" value="<% out.print(horaL6); %>">
                                </td>
                                <td>
