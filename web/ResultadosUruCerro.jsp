        ...
        <section>
            ...
            <form action="VueloReservado.jsp" method="post">
                ...
                <table class="tablas">
                    ...
                    <tbody>
                        <c:choose>
                            <c:when test="${origen.equals('UCM') && destino.equals('Madrid') || origen.equals('EM') && destino.equals('CerroLargo')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                            ...
                            <c:when test="${origen.equals('UCM') && destino.equals('SaoPaulo') || origen.equals('BES') && destino.equals('CerroLargo')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('UCM') && destino.equals('RioDeJaneiro') || origen.equals('BER') && destino.equals('CerroLargo')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('UCM') && destino.equals('NuevaYork') || origen.equals('ENN') && destino.equals('CerroLargo')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('UCM') && destino.equals('LA') || origen.equals('ECL') && destino.equals('CerroLargo')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('UCM') && destino.equals('Florida') || origen.equals('EFO') && destino.equals('CerroLargo')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('UCM') && destino.equals('Toronto') || origen.equals('COT') && destino.equals('CerroLargo')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('UCM') && destino.equals('London') || origen.equals('COL') && destino.equals('CerroLargo')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('UCM') && destino.equals('Paris') || origen.equals('FP') && destino.equals('CerroLargo')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('UCM') && destino.equals('Roma') || origen.equals('IR') && destino.equals('CerroLargo')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('UCM') && destino.equals('Lisboa') || origen.equals('PL') && destino.equals('CerroLargo')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('UCM') && destino.equals('Oslo') || origen.equals('NO') && destino.equals('CerroLargo')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('UCM') && destino.equals('Dublin') || origen.equals('ID') && destino.equals('CerroLargo')}">
                                 <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('UCM') && destino.equals('Moscu') || origen.equals('RM') && destino.equals('CerroLargo')}">
                               <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('UCM') && destino.equals('SanPeter') || origen.equals('RS') && destino.equals('CerroLargo')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('UCM') && destino.equals('Auckland') || origen.equals('NA') && destino.equals('CerroLargo')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('UCM') && destino.equals('Sydney') || origen.equals('AS') && destino.equals('CerroLargo')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
                            ...
                            <c:when test="${origen.equals('UCM') && destino.equals('CiudadMexico') || origen.equals('CDMX') && destino.equals('CerroLargo')}">
                                <tr>
                                    <td>
                                        Hora de salida: 
                                        <% horaS1 = horario.horaSalida() + " : " + horario.minutoSalida();
